...
Белые списки — список российских сервисов, которые работают при "отключении мобильного интернета".

Обход белых списков отличается у каждого пользователя, в зависимости от оператора и региона. То, что работает у одного, может не работать у другого, **универсального решения нет**!

Для подключения к конфигам используйте одно из этих приложений:
- [v2rayN](/network/vpns/v2rayn) (Windows, Linux, macOS)
- [v2rayNG](/network/vpns/v2rayng) (Android)
- Exclave (Android)
- V2box (iOS, Android)
...
```
(для кабельного интернета ⬆️)
```
https://raw.githubusercontent.com/igareck/vpn-configs-for-russia/refs/heads/main/Vless-Reality-White-Lists-Rus-Mobile.txt
```
(для мобильного интернета⬆️)
```
...
```
```
vless://29187857-4a1f-4d1e-88eb-0016771e0dbb@104.18.82.55:443/?type=ws&encryption=none&flow=&host=vless.hubp.de&path=Join---PLANB_NET---Join---PLANB_NET---Join---PLANB_NET---Join---PLANB_NET&security=tls&sni=vless.hubp.de&alpn=h3&fp=chrome#%F0%9F%8F%B4%E2%80%8D%E2%98%A0%EF%B8%8F%40FreakConfig
```
```
...
```
(для V2RayTun, Happ, v2rayNG, v2box, [Hiddify](/network/vpns/hiddify) ⬆️)
```
