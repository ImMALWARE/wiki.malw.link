...
1.  Пользователь устанавливает приложение VPN-сервиса на своё устройство (либо устанавливает приложение, позволяющее подключиться к любым серверам, такое как [AmneziaVPN](/network/vpns/amneziavpn), [Hiddify](/network/vpns/hiddify), Outline и т.д. и вводит ключ, предоставляемый VPN-сервисом). Чаще всего ключом является [ссылка-подписка](/network/vpns/sublinks).
...
4.  VPN-сервер, находясь в другой сети, перенаправляет запросы пользователя к нужным ресурсам, как если бы устройство находилось в локальной сети сервера.