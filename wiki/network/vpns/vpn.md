...
*   **Сервер** — компьютер или устройство, на котором запущена VPN-служба. Он принимает соединения от клиентов.
...
3.  VPN-сервер, находясь в локальной сети, получает запросы от клиента и перенаправляет их к соответствующим ресурсам сети.
