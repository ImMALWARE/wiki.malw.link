...
2. Выберите сетевой интерфейс для захвата трафика. В моём случае это `enp3s0`.
    <img src="/img/network/get-domains/pc-1.png" style="display: block; margin: 15px auto;">
...
4. Запустите нужное приложение. В Wireshark вы можете увидеть список доменов.
    <img src="/img/network/get-domains/pc-2.png" style="display: block; margin: 15px auto;">
