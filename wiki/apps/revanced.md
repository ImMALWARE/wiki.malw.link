...
**ReVanced Xposed** — это модуль для фреймворка [Xposed](/android/xposed), который позволяет применять патчи **ReVanced** к приложениям «на лету», без необходимости перепаковывать APK.
