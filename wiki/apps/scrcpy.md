...
**Возможности:**
* Передача экрана (Android 5.0+).
* Передача аудио (Android 11+).
* Общий буфер обмена (копирование и вставка текста между ПК и смартфоном).
* Управление смартфоном с помощью мыши и клавиатуры компьютера.
* На Linux доступна трансляция экрана в виртуальную камеру (через v4l2).

Официальный репозиторий: https://github.com/Genymobile/scrcpy.

В документации (README) можно найти подробные инструкции и способы решения частых проблем.
