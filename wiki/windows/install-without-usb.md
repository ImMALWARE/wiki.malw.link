...
## Шаг 3: Подключите ISO-образ и запустите установщик
...
Для этого [выполните команду в Командной строке от имени администратора](/windows/run):
```bat
pnputil.exe /add-driver C:\Windows.old\drivers /subdirs /install
```
...
Если вам больше не нужны файлы старой системы, удалите их, следуя инструкции [Очистка диска в Windows с помощью cleanmgr](/windows/cleanmgr).
